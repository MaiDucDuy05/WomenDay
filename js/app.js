$(window).on("load", function () {
  ...
  const askedName = prompt("Click OK to start");
  ...
  var typed = new Typed("#text", {
    strings: [
      "On the occasion of Vietnamese Women's Day, I wish you all the best! May you continue to shine with happiness and achieve great success in all you do. Keep smiling and enjoy this special day! 🌸</b>",
    ],
    startDelay: 4500,
    typeSpeed: 92,
    loop: false,
